  ...
  return (
    <footer className={`bg-${props.theme}`}>
      <ul>
        ...
        <li><a className={`text-${props.theme === 'light' ? 'dark' : 'light'}`} href="/">Resume <ion-icon name="ribbon"></ion-icon></a></li>
      ...
      <ul>
        ...
        <li><a className={`text-${props.theme === 'light' ? 'dark' : 'light'}`} href="/">Github <ion-icon name="logo-github"></ion-icon></a></li>
        <li><a className={`text-${props.theme === 'light' ? 'dark' : 'light'}`} href="/">Linkedin <ion-icon name="logo-linkedin"></ion-icon></a></li>
